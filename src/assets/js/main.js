...
//Vapid public key.
var applicationServerPublicKey = 'BN-nrOkGNpHf3CTcY8e5CqP35C1eerapyAEGgotvZpVxM11ITjYgDp9plc8eIBaR3IH0DqjGRIAmouBIQBJ9LzU';
...
function sendSubscriptionToServer(endpoint, key, auth) {
	...
	localStorage.setItem('PushSubscribe', JSON.stringify({publicKey: encodedKey, auth: encodedAuth, notificationEndPoint: endpoint}));
    // $.ajax({
        // type: 'POST',
        // url: url,
