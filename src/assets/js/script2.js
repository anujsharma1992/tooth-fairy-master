...
$('.i-accordion2').on('show.bs.collapse', function(n){
  $(n.target).siblings('.panel-heading-change').find('.panel-titlechng i').toggleClass('fa-angle-down fa-angle-up');
});
$('.i-accordion2').on('hide.bs.collapse', function(n){
  $(n.target).siblings('.panel-heading-change').find('.panel-titlechng i').toggleClass('fa-angle-up fa-angle-down ');
});
...
function Timer(duration, display) 
{
    ...
    setInterval(function () {
        hours = parseInt((timer /3600)%05, 10)
