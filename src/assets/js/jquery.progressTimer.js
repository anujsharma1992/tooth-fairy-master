(function ($) {
    ...
    $.fn.progressTimer.defaults = {
        ...
        warningStyle: 'btn-primary',  //bootstrap progress bar style in the warning phase
        completeStyle: 'btn-primary'  //bootstrap progress bar style at completion of timer
    };
}(jQuery));
