...
declare var OT:any;
@Component({
  selector: 'app-vendor-appointment-details',
  templateUrl: './vendor-appointment-details.component.html',
  providers: [UserService, StripeService, ChatService],
  styleUrls: ['./vendor-appointment-details.component.css']
})
export class VendorAppointmentDetails implements OnInit {
