...
export class AdminEditUserComponent implements OnInit {
	...
	constructor(private _spotService: UserService, private _router: Router, private route: ActivatedRoute) { // all Dependency should be injected here before use
  	}
	...
	async updateSpot() {
        ...
        if(res.code !== 200) {
            ...
            this.sucMsgVal = true;
            this.sucMsg = 'User has been updated successfully';
            this.errorMsg = '';
